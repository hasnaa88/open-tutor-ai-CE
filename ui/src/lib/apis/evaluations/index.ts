...
export const getConfig = async (token: string = '') => {
	...
	const res = await fetch(`${TUTOR_API_BASE_URL}/self_regulation/config`, {
		method: 'GET',
		headers: {
...
export const exportAllFeedbacks = async (token: string = '') => {
	...
	const res = await fetch(`${TUTOR_API_BASE_URL}/self_regulation/feedbacks/all/export`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const createNewFeedback = async (token: string, feedback: object) => {
	...
	const res = await fetch(`${TUTOR_API_BASE_URL}/self_regulation/feedback`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getFeedbackById = async (token: string, feedbackId: string) => {
	...
	const res = await fetch(`${TUTOR_API_BASE_URL}/self_regulation/feedback/${feedbackId}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',

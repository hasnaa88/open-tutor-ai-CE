	...
	<div class=" flex max-w-full w-full mx-auto px-1 pt-0.5 bg-transparent">
		<div class="flex items-center w-full max-w-full">
			...
			{#if shareEnabled || !!chat?.id}
				<div
					class="absolute left-1/2 transform -translate-x-1/2 flex justify-center items-center z-20"
					...
					>
						...
						<div class="relative flex items-center h-full">
							...
							<div class="w-1/2 h-full flex items-center justify-center z-10">
								<span
									class="font-medium uppercase text-[10px] sm:text-xs transition-colors duration-300"
